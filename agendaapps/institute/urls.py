...
urlpatterns = [
    ...
    path('institution/<uuid:uuid>/edit/', views.institution_edit, name='institution_edit'),
    path('institution/<uuid:uuid>/delete/', views.institution_delete, name='institution_delete'),
