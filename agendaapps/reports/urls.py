...
urlpatterns = [
    ...
    # Mensual
    path('report/<int:year>/mensal/', views.report_based_mensual, name='report_based_mensual'),
    path('report/<int:year>/mensal/<slug:name_slug>/', views.report_based_mensual_detail, name='report_based_mensual_detail'),
    ...
    path('report/<int:year>/mensal/<slug:name_slug>/canceled/', views.report_based_mensual_canceled_detail, name='report_based_mensual_canceled_detail'),
    path('report/<int:year>/mensal/<slug:name_slug>/<slug:name_cat_slug>/', views.report_based_mensual_category_detail, name='report_based_mensual_category_detail'),
    path('report/<int:year>/mensal/<slug:name_slug>/<slug:name_cat_slug>/concluded/', views.report_based_mensual_category_concluded_detail, name='report_based_mensual_category_concluded_detail'),
    path('report/<int:year>/mensal/<slug:name_slug>/<slug:name_cat_slug>/canceled/', views.report_based_mensual_category_canceled_detail, name='report_based_mensual_category_canceled_detail'),
    ...
    path('report/<int:year>/upcoming/list', views.report_based_upcomingagenda_annual, name='report_based_upcomingagenda_annual'),


    #Daliy  
    path('report/daliy/', views.report_based_daily, name='report_based_daily'),
    ...
    path('report/all/agenda/<int:year>/upcoming/', views.print_all_reportupcomingagenda_annual, name='print_all_reportupcomingagenda_annual'),




    path('report/agenda/daily/<slug:title_slug>/', views.print_each_reportagenda_daily, name='print_each_reportagenda_daily'),
