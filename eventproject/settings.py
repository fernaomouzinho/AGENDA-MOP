...
TEMPLATE_DIR = os.path.join(
    EVENTPROJECT_DIR, "eventapps/templates")  # ROOT dir for templates
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'eventproject.context.menu_home',
            ],
        },
    },
]
...
STATICFILES_DIRS = (
    os.path.join(EVENTPROJECT_DIR, 'eventapps/static'),
)

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(EVENTPROJECT_DIR, 'eventapps/media')
